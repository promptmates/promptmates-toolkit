...
**Your job search is too narrow.** You are searching for titles you have held, at companies you have heard of, on platforms you already know. NextGig Scout expands your search by mapping the skills you have to roles you have not considered.

Paste your resume into Claude Code, answer a few questions, and NextGig Scout will:
...
NextGig Scout inverts the logic of a corporate sourcing tool. Instead of "here's a role, find candidates," it asks "here's a candidate, find roles."
...
NextGig Scout identifies those gaps and fills them.
...
### Step 1: Download NextGig Scout

1. Click the green **Code** button on this GitHub page
2. Click **Download ZIP**
3. Unzip the downloaded file
4. Find the `nextgig-scout` folder inside
...
- `skills/nextgig-scout.md` → into your project's `.claude/skills/` folder
...
|---|---|
| `/nextgig-scout` | Full interactive flow: intake questions, profile expansion, live search, results |
...
NextGig Scout queries public ATS APIs and job boards:
...
NextGig Scout generates Boolean search strings customized to your expanded profile. These are copy-paste ready for:
...
- **AI is a tool, not a magic wand.** NextGig Scout expands your search. You still need to apply, network, and show up. But now you are searching smarter.
...
**"Claude does not recognize /nextgig-scout"**
- Make sure `nextgig-scout.md` is in `.claude/skills/` (the dot matters)
...
- NextGig Scout asks you to confirm titles before searching. Remove any that feel off and add any it missed. Your judgment matters here.
